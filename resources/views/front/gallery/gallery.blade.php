...
<main id="main">
    <section class="gallery_section">
                ...
                <div class="row">
                    ...
                    <div class="col-6 col-sm-3 col-lg-2">
                        <div class="pictures_item" >
                            <p id="image_id" class="point_image" value=""  data-bs-imageid="{{ $img_url->message_id }}"
                            data-bs-link="{{ $img_url->media_url }}" style="color: white;position: absolute;margin-left: 13%;">
                            ...
                            <a data-fancybox="gallery" data-src="{{ $img_url->media_url }}">
                                    <img src="{{ $img_url->media_url }}">
                            </a>
                        </div>
                    </div>
                    <!-- <div class="col-6 col-sm-3 col-lg-2">
        ...
        @endforeach
        @else
        <div style="display: flex;color: white;font-size: 34px;justify-content: center;margin: 40px;font-weight: 700;">
            No pictures found</div>
        @endif
    </section>
</main>
<!-- End #main -->
