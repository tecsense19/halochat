    ...
    <section class="position-relative">
        <div class="container-fluid g-0">
            <div class="all_details_box">
                <div class="chat-menu chat_mobile" id="chat-menu">
                    ...
                    <a href="{{ route('chat.message', ['id' => $chat['user_profile']->profile_id]) }}" data-profile-id="{{ $chat['user_profile']->profile_id }}" id="chatLink_{{ $chat['user_profile']->profile_id }}">
                        ...
                        <div id="content" class="content">
                            ...
                            <div class="chat_content">
                                <div class="row">
                                    ...
                                    @if(!empty($getall_Messages))
                                        @foreach ($getall_Messages as $chat_user)
                                            @if($chat_user->sender_id == $chat_user->user_id)
                                            <p id="message" style="display: none;">{{ $chat_user->message_text }}</p>
                                                <div class="volume">
                                    ...
                                    @endif
                                    @if($chat_user->receiver_id == $chat_user->user_id)
                                    <div class="col-12">
                                        <div class="send_message">
                                            <span>{{ $chat_user->message_text }}</span>
                                        </div>
                                    </div>
                                    @endif
                                 @endforeach
...
<main id="main" class="mobile_view" class="pt-0" style="display: none;">
    <section class="position-relative">
        <div class="container-fluid g-0">
            <div class="all_details_box">
                <div class="chat-menu" id="chat-menu">
                    ...
                    @endphp
                    <!-- {{ route('chat.message', ['id' => $chat['user_profile']->profile_id]) }} -->
                    <a href="{{ route('chat.message', ['id' => $chat['user_profile']->profile_id]) }}">
                        <div class="chat-admin" id="mobile_view">
                            <div class="chat-profile">
                                <img src="{{ $imgUrl2 }}">
