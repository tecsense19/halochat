      ...
      <div class="form_sing_up">
        ...
        {!! csrf_field() !!}
          ...
          <div class="contact_details">
            ...
            <img src="{{ URL::asset('public/front/img/user_svg.png') }}" class="lock-icon" height="18" width="18"> 
          ...
          <div class="contact_details">
            ...
            <span>By signing up, you agree to <a href="{{ route('terms.terms') }}">Terms of Service</a></span>
          </div>
        </form>
