...
// $ad_checkpoint = isset($profilegloble->ad_checkpoint ) ? $profilegloble->ad_checkpoint : '';
// $ad_clip_skip = isset($profilegloble->ad_clip_skip ) ? $profilegloble->ad_clip_skip : '';
// $ad_confidence = isset($profilegloble->ad_confidence ) ? $profilegloble->ad_confidence : '';
// $ad_controlnet_guidance_end = isset($profilegloble->ad_controlnet_guidance_end ) ? $profilegloble->ad_controlnet_guidance_end : '';
// $ad_controlnet_guidance_start = isset($profilegloble->ad_controlnet_guidance_start ) ? $profilegloble->ad_controlnet_guidance_start : '';
// $ad_controlnet_model = isset($profilegloble->ad_controlnet_model ) ? $profilegloble->ad_controlnet_model : '';
// $ad_controlnet_module = isset($profilegloble->ad_controlnet_module ) ? $profilegloble->ad_controlnet_module : '';
// $ad_controlnet_weight = isset($profilegloble->ad_controlnet_weight ) ? $profilegloble->ad_controlnet_weight : '';
// $ad_denoising_strength = isset($profilegloble->ad_denoising_strength ) ? $profilegloble->ad_denoising_strength : '';
// $ad_dilate_erode = isset($profilegloble->ad_dilate_erode ) ? $profilegloble->ad_dilate_erode : '';
// $ad_inpaint_height = isset($profilegloble->ad_inpaint_height ) ? $profilegloble->ad_inpaint_height : '';
// $ad_inpaint_only_masked = isset($profilegloble->ad_inpaint_only_masked ) ? $profilegloble->ad_inpaint_only_masked : '';
// $ad_inpaint_only_masked_padding = isset($profilegloble->ad_inpaint_only_masked_padding ) ? $profilegloble->ad_inpaint_only_masked_padding : '';
// $ad_inpaint_width = isset($profilegloble->ad_inpaint_width ) ? $profilegloble->ad_inpaint_width : '';
// $ad_mask_blur = isset($profilegloble->ad_mask_blur ) ? $profilegloble->ad_mask_blur : '';
// $ad_mask_k_largest = isset($profilegloble->ad_mask_k_largest ) ? $profilegloble->ad_mask_k_largest : '';
// $ad_mask_max_ratio = isset($profilegloble->ad_mask_max_ratio ) ? $profilegloble->ad_mask_max_ratio : '';
// $ad_mask_merge_invert = isset($profilegloble->ad_mask_merge_invert ) ? $profilegloble->ad_mask_merge_invert : '';
// $ad_mask_min_ratio = isset($profilegloble->ad_mask_min_ratio ) ? $profilegloble->ad_mask_min_ratio : '';
// $ad_model = isset($profilegloble->ad_model ) ? $profilegloble->ad_model : '';
// $ad_negative_prompt = isset($profilegloble->ad_negative_prompt ) ? $profilegloble->ad_negative_prompt : '';
// $ad_noise_multiplier = isset($profilegloble->ad_noise_multiplier ) ? $profilegloble->ad_noise_multiplier : '';
// $ad_prompt = isset($profilegloble->ad_prompt ) ? $profilegloble->ad_prompt : '';
// $ad_restore_face = isset($profilegloble->ad_restore_face ) ? $profilegloble->ad_restore_face : '';
// $ad_sampler = isset($profilegloble->ad_sampler ) ? $profilegloble->ad_sampler : '';
// $ad_steps = isset($profilegloble->ad_steps ) ? $profilegloble->ad_steps : '';
// $ad_use_cfg_scale = isset($profilegloble->ad_use_cfg_scale ) ? $profilegloble->ad_use_cfg_scale : '';
// $ad_use_checkpoint = isset($profilegloble->ad_use_checkpoint ) ? $profilegloble->ad_use_checkpoint : '';
// $ad_use_clip_skip = isset($profilegloble->ad_use_clip_skip ) ? $profilegloble->ad_use_clip_skip : '';
// $ad_use_inpaint_width_height = isset($profilegloble->ad_use_inpaint_width_height ) ? $profilegloble->ad_use_inpaint_width_height : '';
// $ad_use_noise_multiplier = isset($profilegloble->ad_use_noise_multiplier ) ? $profilegloble->ad_use_noise_multiplier : '';
// $ad_use_sampler = isset($profilegloble->ad_use_sampler ) ? $profilegloble->ad_use_sampler : '';
// $ad_use_steps = isset($profilegloble->ad_use_steps ) ? $profilegloble->ad_use_steps : '';
// $ad_use_vae = isset($profilegloble->ad_use_vae ) ? $profilegloble->ad_use_vae : '';
// $ad_vae = isset($profilegloble->ad_vae ) ? $profilegloble->ad_vae : '';
// $ad_x_offset = isset($profilegloble->ad_x_offset ) ? $profilegloble->ad_x_offset : '';
// $ad_y_offset = isset($profilegloble->ad_y_offset ) ? $profilegloble->ad_y_offset : '';
// $is_api = isset($profilegloble->is_api ) ? $profilegloble->is_api : '';
...
<!-- <script>
    ...
    checkbox.addEventListener('change', function() {
        // If checkbox is checked, hide the div; otherwise, show the div
        if (checkbox.checked) {
            divToHide.style.display = 'block';
        } else {
            divToHide.style.display = 'none'; // or 'inline', 'inline-block', etc., depending on your layout
        }
    });
</script>
...
<script>
    ...
    checkbox1.addEventListener('change', function() {
        ...
        if (checkbox1.checked) {
            ...
            divToHide1.style.display = 'none'; // or 'inline', 'inline-block', etc., depending on your layout
        }
    });
</script> -->
