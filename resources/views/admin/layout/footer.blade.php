<footer class="footer">
    ...
    <script src="{{ URL::asset('public/vendors/progressbar.js/progressbar.min.js') }}"></script>
    <script src="{{ URL::asset('public/vendors/jvectormap/jquery-jvectormap.min.js') }}"></script>
    <script src="{{ URL::asset('public/vendors/jvectormap/jquery-jvectormap-world-mill-en.js') }}"></script>
    <script src="{{ URL::asset('public/vendors/owl-carousel-2/owl.carousel.min.js') }}"></script>
    ...
    <script src="{{ URL::asset('public/vendors/typeahead.js/typeahead.bundle.min.js') }}"></script>
    <!-- End plugin js for this page -->
